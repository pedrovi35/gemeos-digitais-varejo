...
st.set_page_config(page_title="Central de Operações ML · Gêmeo Digital", page_icon="assets/favicon.svg", layout="wide")
...
section_banner("ARTEFATOS · REGISTRO DE MODELOS")
...
section_banner("CAMADA GOLD · risk_scores")
