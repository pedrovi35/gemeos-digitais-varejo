...
st.set_page_config(page_title="Inteligência de Ruptura · Gêmeo Digital", page_icon="assets/favicon.svg", layout="wide")
...
exec_header(
    eyebrow="INTELIGÊNCIA DE RUPTURA",
...
section_banner("SUPERFÍCIE DE RISCO · LOJA × CATEGORIA", hint="risco = SKUs em CRÍTICO/RUPTURA (%)")
...
# ── AI insight ─────────────────────────────────────────────────────
section_banner("IA · DIAGNÓSTICO E RECOMENDAÇÕES")
