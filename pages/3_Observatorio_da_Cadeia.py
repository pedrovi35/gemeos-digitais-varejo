...
st.set_page_config(page_title="Observatório da Cadeia · Gêmeo Digital", layout="wide")
...
# ── Hero ───────────────────────────────────────────────────────────
exec_header(
    eyebrow="OBSERVATÓRIO DA CADEIA DE ABASTECIMENTO",
...
# ── Ranking ────────────────────────────────────────────────────────
section_banner("RANKING DE FORNECEDORES · OTD × TEMPO DE ENTREGA")
if not perf.empty:
    view = perf.copy()
...
# ── AI commentary ──────────────────────────────────────────────────
section_banner("IA · DIAGNÓSTICO DA REDE")
