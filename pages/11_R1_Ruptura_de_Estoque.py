...
st.set_page_config(page_title="R1 · Ruptura de Estoque", page_icon="assets/favicon.svg", layout="wide")
from components.rupture_center import render_rupture_center
from models.shared.registry import RuptureCode
render_rupture_center(RuptureCode.R1, eyebrow="R1 · RUPTURA DE ESTOQUE",
