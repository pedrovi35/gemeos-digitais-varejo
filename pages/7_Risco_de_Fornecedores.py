...
st.set_page_config(page_title="Risco de Fornecedores · Gêmeo Digital", layout="wide")
...
exec_header(
    eyebrow="CENTRAL DE RISCO DE FORNECEDORES",
...
# ── Risk × OTD scatter ─────────────────────────────────────────────
section_banner("DISPERSÃO · OTD × TEMPO DE ENTREGA · COR = SCORE DE RISCO")
fig = px.scatter(
...
# ── AI commentary ──────────────────────────────────────────────────
section_banner("IA · BRIEFING DE FORNECEDORES")
ai_insight(f"""
