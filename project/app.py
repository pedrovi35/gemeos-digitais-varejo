...
st.set_page_config(
    page_title="Gêmeo Digital · Supply Chain Tower",
...
def _render_main() -> None:
    ...
    section_banner("OPERATIONAL HEALTH · NETWORK INTELLIGENCE")
    ...
    with c1:
        ...
        radar_vals = {
            "Service Lvl": sl * 100, "Fill Rate": fill * 100,
            "OTIF":        otif * 100, "Forecast": (1 - mape) * 100,
            "Disponib.":   (1 - so) * 100,
        }
    ...
    section_banner("AI INSIGHT · OPERATIONAL INTELLIGENCE")
